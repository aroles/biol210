...
* **REQUIRED READING:** Before attempting the problem set, watch the content videos (see agenda) and [read this background information](articles/ps1reading.html).
...
<b>When you are finished, check your responses on the [key for PS1](articles/ps1key.html).</b>