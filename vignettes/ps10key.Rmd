...
pkgdown:
  as_is: true
---
<text style="color:blue">This is the key for PS 10. Before reading this document, you should have completed the problems. Use this key to check and correct your work BEFORE submitting the corrected version via the google form.</text>
...
<text style="color:blue">Remembering the evolutionary forces we’re thinking about are: mutation; nonrandom mating; genetic drift; gene flow; selection. We won’t consider mutation much as it’s a slow process and not so different between allopatric and sympatric.</text>
...
<text style="color:blue">There are mutliple possible reasonable responses. Here are a few examples:</text>

<text style="color:blue">Closely-related species that happen (by chance) to have evolved so that they are genetically incompatible will not be able to produce fertile hybrids. This could happen due to a change in the structure of chromosomes so that homologous chromosomes can no longer pair up correctly during meiosis.</text>
...
<text style="color:blue">If growth rate was not density-dependent, then we’d expect all the growth curves to completely overlap – they would all grow at the same rate, reaching the same max size and at the same time.</text>
</ul>
<br>
