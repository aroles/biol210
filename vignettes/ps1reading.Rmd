...
Refer back to the [Oak Phylogeny Sheet](sheets/sci_articles/Oak.Phylogeny.Worksheet.jpg), and find Trees A, B, and C. Each of these three trees has the same species as in Tree 1, but the relationships among them are different; i.e. at least some of the relationships differ in each of these three trees. However, ONE of the three shows the *exact same* relationships as in Tree 1. Which one?
...
Now let's practice taxa and clades—look at Tree 1 on the [Oak Phylogeny Sheet](sheets/sci_articles/Oak.Phylogeny.Worksheet.jpg) and answer the following questions.
...
Let’s look at a straightforward example of this process in our original oak example. Go to Tree 1 on the [Oak Phylogeny Sheet](sheets/sci_articles/Oak.Phylogeny.Worksheet.jpg) and answer the following questions:
