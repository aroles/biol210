...
- Exhausting Flex Days: Once your 3 Flex Days are used, late work will
  automatically receive an Unsatisfactory (U) unless cleared using a
  Token (1 Token = 24-hour late submission).
...
after the first month of classes (by Oct 2) and a second at the end of
the term (by Dec 14).** For each, you will complete and submit the
